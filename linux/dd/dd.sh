...
function Start() {
  ...
  wget --no-check-certificate -qO installdd.sh "https://zxs008.github.io/local/linux/dd/installdd.sh" && chmod +x installdd.sh
  ...
  case $N in
    ...
    14) echo -e "\nPassword: $tmpPassWord\n"; read -s -n1 -p "Press any key to continue..." ; bash installdd.sh -d 12 -v 64 -p $tmpPassWord $DMIRROR ;;
